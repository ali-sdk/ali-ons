...
const ClientRemotingProcessor = require('./client_remoting_processor');
...
class MQClient extends MQClientAPI {
  ...
  constructor(clientConfig) {
    ...
    this._clientRemotingProcessor = new ClientRemotingProcessor(this);
  ...
  selectProducer(group) {
    return this._producerTable.get(group);
  }
